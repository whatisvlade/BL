...
(function () {
    ...
    const modes = [
        ...
        'smooth_filter', 'pyramid_up', 'median_filter_simple',
        'gaussian_blur_simple', 'gray_blur_and_pyramid'
    ];
    ...
    async function sendCaptchaToOcrSpace(dataUrl) {
        ...
        const r = await fetch('https://apipro1.ocr.space/parse/image', { method: 'POST', body: form });
