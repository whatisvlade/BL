...
(function () {
        ...
        for (const url of TEST_URLS) {
            try {
                ...
                if (res.ok) {
                    ...
                    setTimeout(() => {
                        window.location.href = 'https://appointment.blsspainbelarus.by/Global/account/Login?returnUrl=%2FGlobal%2Fappointment%2Fnewappointment&err';
                    }, 4000);
                    break;
                }
            } catch (e) {}
    ...
    function replaceErrorTexts(isIpBlocked) {
        const errorMappings = [
            ...
            { text: 'You have reached maximum number of requests from this account. Please try after sometime', message: 'СМЕНИТЕ АЙПИ', notify: false },
